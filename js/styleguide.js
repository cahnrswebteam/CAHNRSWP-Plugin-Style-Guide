(function($){
	...
	$( '.style-guide-toc li:not(.current_page_ancestor):not(.current_page_item) ul' ).hide();
	$( '.style-guide-toc li.current_page_item > a > span, .style-guide-toc li.current_page_ancestor > a > span' ).addClass( 'disclosed' );
